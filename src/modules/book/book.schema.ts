...
export const CreateBookSchema = z.object({
    ...
    autor: z.string().length(24, "ID do autor inválido"),
...
export const UpdateBookSchema = CreateBookSchema.partial().omit({ autor: true }).refine(data => Object.keys(data).length > 0, {
